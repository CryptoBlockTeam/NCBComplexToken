...
contract("TokenStorage", (accounts) => {
  ...
  //     .then((db) => db.getSupply())
  //     .then((supply) => assert.equal(supply.valueOf(), 0, "total supply is not 0"))
  // })
  //
  //
  ...
  //   }).then(() => db.getSupply())
  //     .then((supply) => assert.equal(supply.valueOf(), 85000, "total supply is not 85000"))
  // })
  //
  //
  ...
  //   }).then(() => db.getSupply())
  //     .then((supply) => assert.equal(supply.valueOf(), 73000, "total supply is not 73000"))
  // })
  //
  //
  ...
  //   }).then((balance) => assert.equal(balance.valueOf(), 73000, "balance in account one is not 73000"))
  // })
  //
  //
  ...
  //   }).then(() => db.getBalance(accounts[1]))
  //     .then((balance) => assert.equal(balance.valueOf(), 30000, "balance is not 30000"))
  // })
  //
  //
  ...
  //       return db.getSupply()
  //     })
  //     .then((supply) => startSupply = supply.valueOf())
  //     .then(() => db.addBalance(accounts[1], 1000000, {from: accounts[1]}))
  //     .then(() => db.getSupply())
  //     .then((supply) => {
